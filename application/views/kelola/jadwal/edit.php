...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-8">
            ...
            <?php echo form_open_multipart('kelola/jadwal/edit/' . $id); ?>

            <div class="form-group row">
                <label for="tgl_jadwal" class="col-sm-2 col-form-label">Tanggal</label>
                <div class="col-sm-10">
                ...
                <div class="col-sm-10">
                    <select class="form-control" id="id_lapangan" name="id_lapangan" required>
                        ...
                        <?php foreach ($lapangan as $a) : ?>
                            <option value="<?php echo $a->id_lapangan ?>" <?= ($a->id_lapangan == $jadwal['id_lapangan']) ? 'selected' : '' ?>><?php echo $a->nama_lapangan ?></option>
                        <?php endforeach ?>
                    </select>
