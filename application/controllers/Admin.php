...
class Admin extends CI_Controller
{
  ...
  public function index()
  {
    ...
    $data['satu'] = $this->daftar_pemohon_m->showDataStatusSatu()->num_rows();
    $data['dua'] = $this->daftar_pemohon_m->showDataStatusDua()->num_rows();
    $data['tiga'] = $this->daftar_pemohon_m->showDataStatusTiga()->num_rows();
    $data['empat'] = $this->daftar_pemohon_m->showDataStatusEmpat()->num_rows();
    $data['lima'] = $this->daftar_pemohon_m->showDataStatusLima()->num_rows();

    $data['enam'] = $this->daftar_pemohon_m->showDataStatusEnam()->num_rows();
    $data['tujuh'] = $this->daftar_pemohon_m->showDataStatusTujuh()->num_rows();
    $data['delapan'] = $this->daftar_pemohon_m->showDataStatusDelapan()->num_rows();
